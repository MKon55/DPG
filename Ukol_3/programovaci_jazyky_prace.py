...
#Vykreslení získaných dat z seznam.txt
def vykresli_graf(data):
    ...
    #Zvolení barev na zásedě GPT co jaká barva nejvíce reprezentuje 
    ax1.bar(jazyky, hodnoty, color=['royalblue', 'orange', 'grey', 'darkviolet', 'darkblue', 'greenyellow'])
    ax1.set_xlabel('Nalezený programovací jazyk')
    ax1.grid(True, axis='y', linestyle='--', alpha=0.7)

    ax2.pie(hodnoty, labels=jazyky, autopct='%1.1f%%', startangle=90, colors=['royalblue', 'orange', 'grey', 'darkviolet', 'darkblue', 'greenyellow'])
    plt.suptitle('Nalezené programovací jazyky na stránce www.jobs.cz', fontsize=16)
    plt.savefig('Vysledny_graf.png')
